  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-purple-400 via-pink-500 to-red-500 p-4">
      <main className="flex flex-col items-center gap-8 w-full max-w-2xl">
        ...
        {/* GitHub Footer */}
        <a
          href="https://github.com/sgfrdgrln"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 bg-white/10 backdrop-blur-sm text-white px-6 py-3 rounded-full font-semibold hover:bg-white/20 transition-all transform hover:scale-105 mt-4"
        >
